...
var conn_string = "mongodb://rafaelpaiva:rafael.9000@ds247077.mlab.com:47077/ubus";
...
exports.insertMany = function(lib, e, callback) {
  if (!executer(lib, e, callback, function(lib, e, callback) {
    lib.insertMany(e.e_array, {w:1}, function(err){
      if(err) { callback(err); }
      else { callback(null); }
    });
  }
  )) {
    console.log("invalid insertMany\n");
  }
}
